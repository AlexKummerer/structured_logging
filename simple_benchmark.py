...
import time
import statistics
from structured_logging import get_logger, LoggerConfig, log_with_context, request_context
import logging
import os
...
def main():
    ...
    print("\n📊 Performance Bottlenecks Identified:")
    print(f"1. Context overhead: {context_stats['mean'] - basic_stats['mean']:.3f}ms per call")
    print(f"2. Timestamp overhead: {ts_stats['mean'] - no_ts_stats['mean']:.3f}ms per call")
